...
class RefferalsDAL extends MongoDAL {
    ...
    setBadReferral(referralId, wrongIdCb, errorCb, successCb) {
        this._updateReferral(referralId, {isGood:false,amount:0,endDate:new Date()}, wrongIdCb, errorCb, successCb);
    }

    setGoodReferral(referralId, amount, wrongIdCb, errorCb, successCb) {
        this._updateReferral(referralId, {isGood:true,amount:amount,endDate:new Date()}, wrongIdCb, errorCb, successCb);
    }
    ...
    createReferral(referrer, referenceTo, clientName, errorCb, successCb) {
        let newReferral = new NewReferral(referrer, referenceTo, clientName, new Date());
